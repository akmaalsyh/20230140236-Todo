        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    {{-- Delete Form (Separate Hidden Form) --}}
                    ...
                    <form action="{{ route('product.update', $product->id) }}" method="POST" class="space-y-6">
                        ...
                        <div class="flex items-center justify-between pt-2">
                            <button type="button" onclick="if(confirm('Are you sure you want to delete this product?')) document.getElementById('delete-product-form').submit();"
                                class="inline-flex items-center gap-1.5 px-3 py-1.5 text-sm font-medium rounded-lg text-red-600 hover:bg-red-50 dark:hover:bg-red-900/30 transition">
                            ...
                            <div class="flex items-center gap-3">
                                <a href="{{ route('product.show', $product->id) }}" 
                                   class="px-4 py-2.5 rounded-lg border border-gray-300 dark:border-gray-600 text-sm font-medium text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-700 transition">
                                    Cancel
                                </a>
                                <button type="submit" 
