        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    {{-- Detail Card --}}
                    <div
                        class="rounded-xl border border-gray-200 dark:border-gray-700 divide-y divide-gray-200 dark:divide-gray-700">

                        {{-- Name --}}
                        <div class="flex items-center px-6 py-4">
                            <div class="w-32 shrink-0 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase">
                                Product Name</div>
                            <div class="text-base font-semibold text-gray-900 dark:text-gray-100">{{ $product->name }}
                            </div>
                        </div>
                        ...
                        <div class="flex items-center px-6 py-4">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <span
                                    class="text-sm text-gray-600 dark:text-gray-300">{{ $product->user->name ?? '-' }}</span>
                            </div>
                        </div>
