                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="rounded-xl border border-gray-200 dark:border-gray-700 divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <div class="flex items-center px-6 py-4">
                            <div class="w-32 shrink-0 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase">Product Name</div>
                            <div class="text-base font-semibold text-gray-900 dark:text-gray-100">{{ $product->name }}</div>
                        </div>

                        {{-- Quantity --}}
                        <div class="flex items-center px-6 py-4">
                            <div class="w-32 shrink-0 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase">Quantity</div>
                            <div>
                        ...
                        {{-- Price --}}
                        <div class="flex items-center px-6 py-4">
                            <div class="w-32 shrink-0 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase">Price</div>
                            <div class="text-lg font-bold text-indigo-600 dark:text-indigo-400 font-mono">
                        ...
                        {{-- Owner --}}
                        <div class="flex items-center px-6 py-4">
                            <div class="w-32 shrink-0 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase">Owner</div>
                            <div class="flex items-center gap-2">
                        ...
                        {{-- Created At --}}
                        <div class="flex items-center px-6 py-4">
                            <div class="w-32 shrink-0 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase">Created At</div>
                        ...
                        {{-- Updated At --}}
                        <div class="flex items-center px-6 py-4">
                            <div class="w-32 shrink-0 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase">Updated At</div>
                            <div class="text-sm text-gray-600 dark:text-gray-300">
